...
class MainClass{
  ...
  static txtBNCen(txt, sz){
    double a1 = sz.toDouble();
    return Text(txt, softWrap:true, textAlign: TextAlign.center, style: TextStyle(color: Colors.black, fontSize: a1, fontFamily: 'Cabinet-Grotesk'));
  }
  ...
  static txtR(txt, sz){
    double a1 = sz.toDouble();
    return Text(txt, softWrap: true, style: TextStyle(color: AppColor.colorAppRed, fontSize: a1, fontFamily: 'Cabinet-Grotesk'));
  }

  static txtN2(txt, sz){
    double a1 = sz.toDouble();
    return Text(txt, softWrap: true, style: TextStyle(color: AppColor.colorApp2, fontSize: a1, fontFamily: 'Cabinet-Grotesk'));
  }
  ...
  static txtB2(txt, sz){
    double a1 = sz.toDouble();
    return Text(txt, softWrap: true, style: TextStyle(color: AppColor.colorApp2, fontSize: a1, fontWeight: FontWeight.bold, fontFamily: 'Cabinet-Grotesk'));
  }

  static dibs(ic, na, txt, cre, col, ctx){
    return Container(
    ...
    return Container(
      ...
      child: RichText(
        text: TextSpan(
          style: TextStyle(
              fontSize: 14,
              color: AppColor.colorApp2,
              fontFamily: 'Cabinet-Grotesk'
          ),
          children: <TextSpan>[
            TextSpan(text: t1),
            TextSpan(text: t2,
                style: TextStyle(color: AppColor.colorApp2,
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Cabinet-Grotesk')),
          ],
  ...
  static cards(txt, col){
    return Container(
      ...
      child: MainClass.txtWN(txt, 14),
    );
  }

  static cards1(txt, col){
    return Container(
      padding: const EdgeInsets.only(top: 2, bottom: 2, left: 6, right: 6),
      decoration: BoxDecoration(
        color: col,
