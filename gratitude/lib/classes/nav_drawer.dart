      ...
      child: Column(
        ...
        children: [
          ClipRRect(
            ...
            child: Image.asset('assets/ava.png', height: 60, width: 60, fit: BoxFit.contain),
          ),
          MainClass.bH(12),
          MainClass.txtWB('Abdul Naim', 16),
        ],
      ),
    ),
  );
    ...
    child: SingleChildScrollView(
      child: Column(
        children: [
          ...
          MainClass.navI('assets/icons/ic3.png', 'Agency', false, context),
          MainClass.navI('assets/icons/ic6.png', 'Jobs', false, context),
        ],
      ),
    ),
  );
